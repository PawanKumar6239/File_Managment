...
public class  welcomescreen{
  ...
  try {
			System.out.println("Do you want to run the application - yes or no?");
			String test = sc.next();
	...
	private static void welcomeScreen() {
		...
		System.out.println("\n******************\n");
		System.out.println("Course End Project");
		System.out.println("Virtual Key for Your Repositories");
		System.out.println("Full Stack Java Developer Name: Priyanka Nagpal");
		System.out.println("\n****************\n");		
	...
	private static void businessOptionsMenu() {
		...
		while(loop) 
		{
			...
			//Display the file manager Options Menu to the Console
			for(int i=0; i<options.length;i++) 
			{
				System.out.println(options[i]);
			}
